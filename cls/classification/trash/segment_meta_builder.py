...
from utils.general import parse_meta_v2, save_meta, parse_meta
...
def main():
    ...
    ROOT_DIR = "/home/achernikov/CLS/DATA"
    MODEL_DIR = f"{ROOT_DIR}/models"
    DATASETS = f"{ROOT_DIR}/datasets"
    META = f"{ROOT_DIR}/meta"
    PICTURE = f"{ROOT_DIR}/pictures"
    
    PICTURE_SEG = f"{ROOT_DIR}/masks"
    ...
    path_models_girls = {
        ...
        "tits_size": f'{MODEL_DIR}/tits_size/v__3_train_eff_48_0.2/checkpoints/epoch=67-step=29716.pt'# /tits_size/v__2_all_eff_36_0.001/checkpoints/epoch=59-step=38280.pt',
    ...
    metas = parse_meta_v2(
        path_models_girls, InferDataset, Aug, Pre, DATASETS, CATEGORYS, META, PICTURE, PICTURE_SEG,
    )
