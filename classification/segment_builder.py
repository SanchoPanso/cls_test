...
from utils.cfg import get_cfg, get_opts, dict2str
from utils.database import update_picture_by_path
from utils.database import Picture
...
def main():
    ...
    create_segments(opts.model_path, opts.pictures_dir, opts.segments_dir, opts.process_all, opts.mark_approved)
