...
python  train_wb.py --cat sex_positions --batch 36 --arch eff --mode train --decay 0.001> ~/nohup.out
# python  train_wb.py --cat hair_color --batch 36 --arch eff --mode all --decay 0.001> ~/nohup.out
# python  train_wb.py --cat body_decoration_body_painting --batch 36 --arch eff --mode train --decay 0.001> ~/nohup.out
# python  train_wb.py --cat body_decoration_piercing --batch 36 --arch eff --mode all --decay 0.001> ~/nohup.out
# python  train_wb.py --cat body_decoration_tatto --batch 36 --arch eff --mode all --decay 0.001> ~/nohup.out
# python  train_wb.py --cat body_type --batch 36 --arch eff --mode all --decay 0.001> ~/nohup.out
# python  train_wb.py --cat tits_size --batch 36 --arch eff --mode all --decay 0.001 --masks True --gray True --vflip True> ~/nohup.out
