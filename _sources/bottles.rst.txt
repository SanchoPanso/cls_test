...
Для лучшей организации работы все данные 
(изображения, метаданные, эксперименты по тренировке моделей)
 группируются внутри одной папки, то есть, говоря фигурально, в отдельной "бутылке".
